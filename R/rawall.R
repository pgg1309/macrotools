...
# I want to convert the above MATLAB function into an R function
# the function returns a list with turning points bcp for peak and bct for through
# the function takes a vector of prices and a cycle length as input
#
